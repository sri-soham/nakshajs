...
BEGIN
  ...
  ELSIF col_type = 'ST_MULTIPOINT' OR col_type = 'ST_POINT' THEN
    style := '<Rule><MarkersSymbolizer fill="#000000" stroke="#ffffff" opacity="0.75" stroke-width="1" stroke-opacity="1.0" width="10" height="10" placement="point" allow-overlap="true" marker-type="ellipse" /></Rule>';
  ...
  ELSE
    style := '<Rule>'
          ...
          || '<MarkersSymbolizer fill="#000000" stroke="#ffffff" opacity="0.75" stroke-width="1" stroke-opacity="1.0" width="10" height="10" placement="point" allow-overlap="true" marker-type="ellipse" />'
          || '</Rule>';
